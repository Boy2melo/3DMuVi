...
\begin{enumerate}[ align=left, label={\textbf{\textbackslash B10\arabic*0\textbackslash}} ]
	\item \textbf{Algorithmuswahl} Algorithmen können dem Workflow entsprechend aus ComboBoxen gewählt werden.
	...
	\item \textbf{Starten} Ein Button soll den Start der Ausführung der ausgewählten Algorithmen ermöglichen.
	...
	\item \textbf{Ansichtsauswahl} Der Nutzer soll zwischen folgenden Ansichten wählen können:
		...
		\end{enumerate}  und der Features bzw. des Matchings von Features auf mehreren Bildern unterscheide
	...
	\item \textbf{Speichern des Workflows} Die Algorithmenauswahl und der gewählte Workflows, falls vorhanden, sollen gespeichert werden können. Dafür steht in der Menüleiste die Einträge „File→Save workflow“ und „File→Save worflow As...“ bereit.
