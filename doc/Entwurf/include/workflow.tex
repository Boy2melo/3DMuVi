...
\newMember{getAvailableWorkflows}{void}{vector<string>}{Gibt eine Liste aller Verfügbaren Workflows aus.}
\newMember{checkAvailableDataTypes}{string}{*AWorkflow}{Instanziiert einen bestimmten Workflow}
\closeMembers
