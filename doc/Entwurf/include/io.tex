...
\beginMembers
\newMemberAbstract{{ResultContext}}{QUrl path}{void}{Erstellt den ResultContext aus vorangegangenen Ergenissen welche im Ordner "path" liegen. }
