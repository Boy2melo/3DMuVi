...
\beginMembers
\newMember{{getGlobal}}{QString name}{QString}{Gibt die Einstellung "name" als QString zurück.}
\newMember{{setGlobal}}{QString name, QString value}{bool}{Setzt den Wert "value" für die globalen Einstellung "name". true, falls erfolgreich, sonst false}
