...
\\
	\begin{enumerate}[align=left, leftmargin=4em, label={\textbf{\textbackslash T2.\arabic*\textbackslash}} ]
		...
		%Es lassen sich nur die Einstellungen aller Algorithmen, die aktuell geladen sich speichern und diese finden sich im ResultContext. Ebenfalls ist das laden von einzelnen Algorithmeneinstellungen aus externen Dateien nicht möglich, aufgrund von Änderungen im Design und Implementierung.
		\\\item \begin{tabular}{|c|c|}
			\hline Modul & Funktion \\
