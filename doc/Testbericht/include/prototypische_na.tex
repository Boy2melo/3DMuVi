...
\textbf{Durchführung:} Erzeugen eines 3D-Modells \newline
\textbf{zusätliche Vorrausetzungen:} Zusätzlich müssen Algorithmenplugins compiliert und für das Framework zur Verfügung gestellt werden.
Nach dem starten, der Bilderauswahl. Können die Algorithmen wie erwartet ausgewählt und deren Parameter eingestellt werden. \newline
...
\textbf{Durchführung} Evaluation von Algorithmen \newline
Nach erfolgreichem 1. Durchlauf, kann das Algorithmenplugin geändert werden und erneut gestartet werden.
Known Bug: Die Settings des geänderten Algorithmenplugins können nicht angepasst werden. Das Geänderte Plugin kann nur mit Default-Parameter gestartet werden. 
...
\textbf{Durchführung} Überprüfen von Logs \newline
...
\begin{enumerate}
	...
	\item Erneute Betrachtung der Ergebnisse.
\end{enumerate}
\textbf{Durchführung} Manipulation von Zwischenergebnissen \newline
...
\textbf{Durchführung} Evaluation von Algorithmen auf mehren Datensätzen \newline
