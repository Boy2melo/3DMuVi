...
\newcommand{\result}[1]{
	\\\textbf{Ergebnis:}
	\IfEqCase{#1}{
		{1}{\textcolor{darkgreen}{\textbf{Erfolgreich}}}
		{2}{\textcolor{orange}{\textbf{Erfolgreich unter Vorbehalt}}}
		{3}{\textcolor{red}{\textbf{Fehlgeschlagen}}}
		{4}{\textcolor{blue}{\textbf{Nicht Implementiert}}}
	}\\\textbf{Testkommentar:}\\
}
