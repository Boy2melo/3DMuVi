...
private:
    ...
    std::function<void(CContextDataStore*)> mExecFunc;

public:
    TestAlgorithm(QStringList inputTypes, QStringList outputTypes);
    /*!
    ...
    */
    ...
    /**
    \brief Setze die Validierungsfunktion
    */
    void setValidateCallback(std::function<bool (const QJsonObject*)> validateFunc);

    /**
    \brief Setze die Ausführungsfunktion
    */
    void setExecCallback(std::function<void(CContextDataStore*)> execFunc);
    ...
    */
    bool ValidateParameters(const QJsonObject*);
private:
    /*!
